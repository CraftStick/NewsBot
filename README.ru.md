...
- 17 RSS-лент (Роскомсвобода, Habr, Meduza, VC, SecurityLab, CNews и др.) с фильтром по ключевым словам
...
- Память тем на месяц: новость из прошлого выпуска не попадёт в следующий
...
- Бюджет запросов на прогон — дневная квота бесплатного тарифа не сгорает на ретраях
